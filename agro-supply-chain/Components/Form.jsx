...
export default ({ 
  ...
  return createShipmentModel ? (
    <div className="fixed inset-0 z-10 overflow-y-auto">
      <div className="fixed inset-0 w-full bg-black opacity-40" onClick={() => setCreateShipmentModel(false)}>   
      </div>
        ...
        <div className="relative w-full max-w-lg p-4 mx-auto bg-white rounded-md shadow-lg">
          ...
          <div className="max-w-sm mx-auto py-3 space-y-3 text-center">
            ...
            <p className="text-[15px] text-gray=600">
              Track or create your own product/shipment
            </p>
            ...
            />
              ...
              text-white bg-indigo-600 hover:bg-index-500 active:bg-indigo-700 rounded-lg ring-offset-2 ring-indigo-600 focus:ring-2'>
                Create Shipment
              </button>
            </form>
          </div>
